...
public class UserLoginRequestParam extends RequestParam {
	...
	public UserLoginRequestParam(String fields) {
		this.fields = fields;
	}

	public UserLoginRequestParam(String name, String pwd) {
		this.name = name;
		this.pwd = pwd;
	}
	...
	public Bundle getParams() throws NetworkException {
		...
		if (name != null) {
			parameters.putString(UserInfo.KEY_NAME, name);
		}
		if (pwd != null) {
			parameters.putString(KEY_PWD, pwd);
		}
		return parameters;
	}
