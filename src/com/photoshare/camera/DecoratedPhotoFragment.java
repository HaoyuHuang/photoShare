 ...
 * 
 */
public class DecoratedPhotoFragment extends BaseFragment {
	...
	public static DecoratedPhotoFragment newInstance(int fragmentViewId) {
		DecoratedPhotoFragment dpf = new DecoratedPhotoFragment();
	...
	public void onSaveInstanceState(Bundle outState) {
		if (outState != null) {
			outState.putParcelable(PhotoBean.KEY_PHOTO, oBitmap);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		if (savedInstanceState != null) {
			if (savedInstanceState.containsKey(KEY_PHOTO_CROP)) {
				mBitmap = savedInstanceState.getParcelable(KEY_PHOTO_CROP);
			}
			if (savedInstanceState.containsKey(PhotoBean.KEY_PHOTO)) {
				oBitmap = savedInstanceState.getParcelable(PhotoBean.KEY_PHOTO);
			}
			if (savedInstanceState.containsKey(KEY_CROP)) {
				isCroping = savedInstanceState.getBoolean(KEY_CROP);
				if (isCroping) {
					startCroping();
				} else {
					resetCroping();
