 ...
 * 
 */
public class DecoratedPhotoUploadFragment extends BaseFragment {
	...
	public static DecoratedPhotoUploadFragment newInstance(int fragmentViewId) {
		DecoratedPhotoUploadFragment dpsf = new DecoratedPhotoUploadFragment();
	...
	protected void onLeftBtnClicked() {
		...
		forward(getDecoratedPhotoShareFragment(), args);
	}
	...
	private void initViews() {
		...
		shareView = new DecoratedPhotoShareView(getActivity().findViewById(
				R.id.decoratingSharePhotoLayoutId), photo);
		shareView.applyView();
