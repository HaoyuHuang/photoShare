...
public class ForumsDetailActivity extends Activity implements BaseActivity
{
	...
	private void initWidgit()
	{
		...
		back.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				Intent intent = new Intent(ForumsDetailActivity.this,
		...
		submint.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				if (remark_submit_content.getText().toString().equals(""))
				{
					...
					Toast.makeText(ForumsDetailActivity.this, "评论不能为空！",
				...
				else
				{
					...
					MainServiceTask MST = new MainServiceTask(
							...
							ForumsDetailActivity.class.getName());
					MainService.addActivityMap(
							ForumsDetailActivity.class.getName(),
							ForumsDetailActivity.this);
	...
	private void getPicRemark(String picid)
	{
		...
		MainServiceTask MST = new MainServiceTask(TaskType.GET_COMMENTS, paras,
				ForumsDetailActivity.class.getName());
		MainService.addActivityMap(ForumsDetailActivity.class.getName(), this);
		MainService.addTaskQueue(MST);
	...
	{
		MainService.removeActivity(ForumsDetailActivity.class.getName());
		super.onDestroy();
	}
